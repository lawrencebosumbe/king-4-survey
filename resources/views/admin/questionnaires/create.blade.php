...
@if(!empty($sections))
                                ...
                                @if($principal->id === 2)
                                        <div class="row">
                                            <div class="col-md-5">
                                                <p class="principal">
                                                    {{ $principal->name }}
                                                    <input type="hidden" name="independence" value="1">
                                                </p>
                                            </div>
                                            <div class="col-md-7"></div>
                                        </div>
                                ...
                                @if($principal->id === 3)
                                        <div class="row">
                                            <div class="col-md-5">
                                                <p class="principal">
                                                    {{ $principal->name }}
                                                    <input type="hidden" name="financial_literacy" value="3">
                                                </p>
                                            </div>
                                            <div class="col-md-7"></div>
                                        </div>
                                ...
                                @if($principal->id === 4)
                                    <div class="row">
                                        <div class="col-md-5">
                                            <p class="principal">
                                                {{ $principal->name }}
                                                <input type="hidden" name="financial_reporting" value="4">
                                            </p>
                                        </div>
                                        <div class="col-md-7"></div>
                                    </div>
                                ...
                                @if($principal->id === 5)
                                    <div class="row">
                                        <div class="col-md-5">
                                            <p class="principal">
                                                {{ $principal->name }}
                                                <input type="hidden" name="interim_financial_reports" value="4">
                                            </p>
                                        </div>
                                        <div class="col-md-7"></div>
                                    </div>
                                ...
                                @if($principal->id === 6)
                                    <div class="row">
                                        <div class="col-md-5">
                                            <p class="principal">
                                                {{ $principal->name }}
                                                <input type="hidden" name="annual_financial_reports" value="3">
                                            </p>
                                        </div>
                                        <div class="col-md-7"></div>
                                    </div>
                                ...
                                @if($principal->id === 7)
                                    <div class="row">
                                        <div class="col-md-5">
                                            <p class="principal">
                                                {{ $principal->name }}
                                                <input type="hidden" name="internal_reports" value="5">
                                            </p>
                                        </div>
                                        <div class="col-md-7"></div>
                                    </div>
                                ...
                                @if($principal->id === 8)
                                    <div class="row">
                                        <div class="col-md-5">
                                            <p class="principal">
                                                {{ $principal->name }}
                                                <input type="hidden" name="independent_auditor" value="8">
                                            </p>
                                        </div>
                                        <div class="col-md-7"></div>
                                    </div>
                                ...
                                @if($principal->id === 9)
                                    <div class="row">
                                        <div class="col-md-5">
                                            <p class="principal">
                                                {{ $principal->name }}
                                                <input type="hidden" name="internal_audit" value="5">
                                            </p>
                                        </div>
                                        <div class="col-md-7"></div>
                                    </div>
                                ...
                                @if($principal->id === 10)
                                    <div class="row">
                                        <div class="col-md-5">
                                            <p class="principal">
                                                {{ $principal->name }}
                                                <input type="hidden" name="agenda_setting" value="2">
                                            </p>
                                        </div>
                                        <div class="col-md-7"></div>
                                    </div>
                                ...
                                @if($principal->id === 11)
                                    <div class="row">
                                        <div class="col-md-5">
                                            <p class="principal">
                                                {{ $principal->name }}
                                                <input type="hidden" name="advanced_materials" value="1">
                                            </p>
                                        </div>
                                        <div class="col-md-7"></div>
                                    </div>
                                ...
                                @if($principal->id === 12)
                                    <div class="row">
                                        <div class="col-md-5">
                                            <p class="principal">
                                                {{ $principal->name }}
                                                <input type="hidden" name="meetings" value="2">
                                            </p>
                                        </div>
                                        <div class="col-md-7"></div>
                                    </div>
                                ...
                                @if($principal->id === 13)
                                    <div class="row">
                                        <div class="col-md-5">
                                            <p class="principal">
                                                {{ $principal->name }}
                                                <input type="hidden" name="private_meetings" value="1">
                                            </p>
                                        </div>
                                        <div class="col-md-7"></div>
                                    </div>
                                ...
                                @if($principal->id === 14)
                                    <div class="row">
                                        <div class="col-md-5">
                                            <p class="principal">
                                                {{ $principal->name }}
                                                <input type="hidden" name="education_knowledge" value="1">
                                            </p>
                                        </div>
                                        <div class="col-md-7"></div>
                                    </div>
                                ...
                                @if($principal->id === 16)
                                    <div class="row">
                                        <div class="col-md-5">
                                            <p class="principal">
                                                {{ $principal->name }}
                                                <input type="hidden" name="performance_assessment" value="1">
                                            </p>
                                        </div>
                                        <div class="col-md-7"></div>
                                    </div>
                                ...
                                @if($principal->id === 17)
                                    <div class="row">
                                        <div class="col-md-5">
                                            <p class="principal">
                                                {{ $principal->name }}
                                                <input type="hidden" name="charter" value="2">
                                            </p>
                                        </div>
                                        <div class="col-md-7"></div>
                                    </div>
                                ...
                                @if($principal->id === 18)
                                    <div class="row">
                                        <div class="col-md-5">
                                            <p class="principal">
                                                {{ $principal->name }}
                                                <input type="hidden" name="communication_with_board" value="1">
                                            </p>
                                        </div>
                                        <div class="col-md-7"></div>
                                    </div>
                                ...
                                @if($principal->id === 19)
                                    <div class="row">
                                        <div class="col-md-5">
                                            <p class="principal">
                                                {{ $principal->name }}
                                                <input type="hidden" name="risk_management" value="2">
                                            </p>
                                        </div>
                                        <div class="col-md-7"></div>
                                    </div>
    ...
    @endforeach
        <div>
            ...
            <a href="{{ route('admin.mysurveys.index') }}" class="btn btn-success">Cancel</a>
        </div>
    </form>
@endif
